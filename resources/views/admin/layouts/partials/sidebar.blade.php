<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link text-center">
        ...
        <span class="brand-text1 font-weight-light1">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                ...
                <li class="nav-item {{ request()->routeIs('admin.categories.*') ? 'menu-is-opening menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.categories.archive') }}"
                                class="nav-link {{ request()->routeIs('admin.categories.archive') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Archives</p>
                            </a>
                        </li>
